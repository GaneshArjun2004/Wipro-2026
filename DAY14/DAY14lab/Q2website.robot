...
Form Interaction Using BuiltIn Keywords
    ...
    # Text Box 
    Input Text    id=input-firstname    arjun
    Input Text    id=input-lastname     ram
    Input Text    id=input-email        arjunram@mail.com
    ...
    # Radio Button for Newsletter is no
